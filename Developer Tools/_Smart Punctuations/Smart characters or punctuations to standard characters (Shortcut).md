It is a coding problem when your OS, especially macOS, automatically changes straight single or double quotes into curly versions while you are drafting code, and then the code fails after you paste it into your IDE / code editor.
