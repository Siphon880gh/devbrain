...
This runs once then returns to your shell session because app.py doesn't keep the script process continually running like python Flask does,.
...
> `docker run --rm test:v1.0 cat /etc/os-release`
