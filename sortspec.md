...
sorting-spec: |-
  ...
  AI Loop Engineering (Aka Loop Prompting) (5. Builds iterative agent workflows that drain loop until a stop condition)
  AI Graph Engineering (6. Builds connected, multi-path reasoning networks)
