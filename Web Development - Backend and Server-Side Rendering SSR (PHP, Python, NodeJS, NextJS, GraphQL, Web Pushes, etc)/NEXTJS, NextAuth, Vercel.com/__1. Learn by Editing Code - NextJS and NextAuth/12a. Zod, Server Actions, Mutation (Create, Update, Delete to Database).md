...
When you click "Create Invoice" at the invoices page, it'll open `localhost:3000/dashboard/invoices/create` which is going to be 404 because we haven't defined a page at that route
