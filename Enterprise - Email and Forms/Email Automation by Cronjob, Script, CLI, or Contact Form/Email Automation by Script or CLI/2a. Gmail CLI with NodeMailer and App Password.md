...
- You must set up a **Gmail app password** if your free gmail account supports it.  
    👉 Follow the steps in [[1a. Create Gmail app password (And see if your Google account supports it)]].

- If Gmail app password does not exist, you may need to go with a different method like [[2b. Gmail CLI with NodeMailer and OAuth2 to Refresh Token]]
