**Where we are**: Docker containers spin up to the next available port number and spin down automatically -> So I added adding Kubernetes -> But now I need Ingress to have domain and subdomains
