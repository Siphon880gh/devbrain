...
Make sure the dependencies are already installed (Instructions at [[_ GET STARTED - Web app ready - Ffmpeg, ctypes, imagemagick, pcregrep, wkhtmltopdf, puppeteer with chrome]]):
