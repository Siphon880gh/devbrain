Many of the shortcuts on VS Code transfer over to Cursor AI. Some shortcuts didn't or have been changed. Here we setup the shortcuts again, and worse case, we setup a similar shortcut key combination.
