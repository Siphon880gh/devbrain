...
- Trigger and Tooling are not matured: Telling it to fire the prompt when a file exists won't be sufficient. You have to explain it to access shell terminal to loop until a file exists, taking advantage of AI agent waiting on shell commands
