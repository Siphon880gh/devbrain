...
But please note you'd have to instruct the prompt or AI agent on how to use shell commands to perform this, because it lacks a matured toolset knowledge as of Dec 2025.
...
However you can automate this by having a series of prompts in the Agents.md or refer to prompt files at a `prompts/` folder.