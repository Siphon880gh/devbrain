...
You may need to grant all tables to a database user. Refer to [[_ PRIMER - Wordpress (Includes Setup)]] which includes the SQL command to do so (CloudPanel isn't matured enough to handle specific privileges of database users)
