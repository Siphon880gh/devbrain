...
![](om4VcrU.png)
^ Provide the username and password to the account that can access such database (or all databases). This would be the login credentials to the command `mysql -h 127.0.0.1 -u root -P 3306 -A -p` (interactive password), or the login into the phpMyAdmin
