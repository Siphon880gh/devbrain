...
init-devtools-sidebar.js loads in devt-sidebar.html for a DevTools sidebar pane to appear as a possible tab choice to the right sidebar when Elements panel is opened:
