...
sequenceDiagram
    ...
    Sidebar->>DevTools: >sb2dt-request-inspected-element
    DevTools->>DevTools: getInspectedElement()
    DevTools-->>Sidebar: dt2sb-response-inspected-element (element innerText)
