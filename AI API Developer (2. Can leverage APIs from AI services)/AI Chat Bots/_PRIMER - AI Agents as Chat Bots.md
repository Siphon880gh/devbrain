...
In order to properly set the AI Agent, you would have to add an AI Agent prompt. For information on how to add such a prompt, refer to [[_PRIMER Chat Bots - Prompt Basics]]
