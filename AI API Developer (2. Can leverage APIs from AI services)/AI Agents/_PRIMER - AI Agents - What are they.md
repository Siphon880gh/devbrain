...
- **React to specific triggers** (file changes, webhooks, scheduled runs, user actions)
- **Work with other AI agents** (Double check another agent's work, etc)
- **Follow deterministic, step-by-step instructions**
- **Produce artifacts** such as files, diffs, reports, or structured outputs

In practice, they function more like programmable workers in a pipeline—closer to CI jobs, background services, or task runners—than general-purpose AI copilots.